...
import { IonItem, IonLabel, IonSpinner, IonList, IonItemDivider, IonIcon, IonText } from "@ionic/angular/standalone";
import { Router } from '@angular/router';
import { addIcons } from 'ionicons';
import { chatboxOutline, createOutline } from 'ionicons/icons';

@Component({
  selector: 'app-side-nav',
  templateUrl: './side-nav.component.html',
  styleUrls: ['./side-nav.component.scss'],
  imports: [IonItemDivider, IonList, IonSpinner, IonLabel, IonItem, IonIcon, IonText],
  standalone: true
})
